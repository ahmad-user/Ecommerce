...
if (!empty($_GET['kategori']) && !empty($_GET['jenis'])) {
    $recmobil = $model->mobilfind($_GET['kategori'], $_GET['jenis']);
}
...
<body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
                    <div class="offcanvas-body">
                        <ul id="navbar" class="navbar-nav text-uppercase justify-content-end align-items-center flex-grow-1 pe-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link me-4 active" href="mobil.php">Mobil</a>
                            </li>
                            <li class="nav-item">
    ...
    <section id="billboard" class="position-relative overflow-hidden bg-light-blue mb-4">
                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-md-6">
                                <div class="banner-content">
                                    <h1 class="display-2 text-uppercase text-dark mb-0">Aksesoris <br> Mobil</h1>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="image-holder pt-5">
                                    <img src="images/velgmobil.png" alt="banner">
                                </div>
                            </div>
                        </div>
                    </div>
