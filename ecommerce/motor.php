...
if (!empty($_GET['kategori']) && !empty($_GET['jenis'])) {
    $recmotor = $model->motorfind($_GET['kategori'], $_GET['jenis']);
}
...
<body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
                    <div class="offcanvas-body">
                        <ul id="navbar" class="navbar-nav text-uppercase justify-content-end align-items-center flex-grow-1 pe-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link me-4 active" href="motor.php">Motor</a>
                            </li>
                            <li class="nav-item">
    ...
    <section id="billboard" class="position-relative overflow-hidden bg-light-blue mb-5">
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-md-6">
                    <div class="banner-content">
                        <h1 class="display-2 text-uppercase text-dark ">Aksesoris Motor</h1>
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="image-holder">
                        <img src="images/stikermotor.jpg" alt="banner" width="650px" class="p-5">
                    </div>
                </div>
            </div>
        </div>
                ...
                <?php foreach ($recmotor as $m) { ?>
                    <div class="col-3">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                <p class="card-text">STOK : &ensp;<?= $m['stok_produk'] ?></p>
                            </div>
